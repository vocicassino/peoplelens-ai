const CACHE='peoplelens-shell-v1';
const SHELL=['./','./index.html','./styles.css','./app.js','./tracker.js','./anomalies.js','./db.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
